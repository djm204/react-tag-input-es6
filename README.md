...
[![NPM](https://nodei.co/npm/react-tag-input-es6.png?downloads=true)](https://www.npmjs.com/package/react-tag-input-es6)
...
```
npm install react-tag-input-es6 --save
```
...
### Thanks
This entire project is just a rework of input-tag-input
